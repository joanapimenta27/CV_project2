...
DATASETS = [
    ...
    # ── Pool Billiard (all 3 splits go into train/val pool) ─────────────────
    {
        ...
        "annotations":     "data/Pool Billiard.v1i.coco/train/_annotations.coco.json",
        "images_dir":      "data/Pool Billiard.v1i.coco/train",
        "is_original":     False,
        "ball_categories": BILLIARD_CATS,
    },
    {
        "name":            "Pool Billiard - valid",
        "annotations":     "data/Pool Billiard.v1i.coco/valid/_annotations.coco.json",
        "images_dir":      "data/Pool Billiard.v1i.coco/valid",
        "is_original":     False,
        "ball_categories": BILLIARD_CATS,
    },
    {
        "name":            "Pool Billiard - test",
        "annotations":     "data/Pool Billiard.v1i.coco/test/_annotations.coco.json",
        "images_dir":      "data/Pool Billiard.v1i.coco/test",
        "is_original":     False,
        "ball_categories": BILLIARD_CATS,
    },
    ...
    # ── Pool Balls Detection (all 3 splits) ──────────────────────────────────
    {
        ...
        "annotations":     "data/Pool Balls Detection.v13-v13.coco/train/_annotations.coco.json",
        "images_dir":      "data/Pool Balls Detection.v13-v13.coco/train",
        "is_original":     False,
        "ball_categories": None,
    },
    {
        "name":            "Pool Balls Detection - valid",
        "annotations":     "data/Pool Balls Detection.v13-v13.coco/valid/_annotations.coco.json",
        "images_dir":      "data/Pool Balls Detection.v13-v13.coco/valid",
        "is_original":     False,
        "ball_categories": None,
    },
    {
        "name":            "Pool Balls Detection - test",
        "annotations":     "data/Pool Balls Detection.v13-v13.coco/test/_annotations.coco.json",
        "images_dir":      "data/Pool Balls Detection.v13-v13.coco/test",
        "is_original":     False,
        "ball_categories": None,
    },
    ...
    # ── Pool Ball Detection (all 3 splits) ───────────────────────────────────
    {
        ...
        "annotations":     "data/Pool Ball Detection.v5i.coco/train/_annotations.coco.json",
        "images_dir":      "data/Pool Ball Detection.v5i.coco/train",
        "is_original":     False,
        "ball_categories": None,
    },
    {
        "name":            "Pool Ball Detection - valid",
        "annotations":     "data/Pool Ball Detection.v5i.coco/valid/_annotations.coco.json",
        "images_dir":      "data/Pool Ball Detection.v5i.coco/valid",
        "is_original":     False,
        "ball_categories": None,
    },
    {
        "name":            "Pool Ball Detection - test",
        "annotations":     "data/Pool Ball Detection.v5i.coco/test/_annotations.coco.json",
        "images_dir":      "data/Pool Ball Detection.v5i.coco/test",
        "is_original":     False,
        "ball_categories": None,
    },
]
